        ...
        <div className="text-center space-y-8 max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Current language: <span className="font-medium text-blue-600 dark:text-blue-400">{lng.toUpperCase()}</span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">React framework with SSR</p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Beautiful UI components</p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Nx Monorepo</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Scalable workspace</p>
            </div>
          </div>
